...
access_key_id = os.getenv('OSS_TEST_ACCESS_KEY_ID', 'LTAIlZg1AYo0Pnyx')

access_key_secret = os.getenv('OSS_TEST_ACCESS_KEY_SECRET', 'wimkdhQ2Kkb9CEyGkvwWy31Gvf8yYo')

bucket_name = os.getenv('OSS_TEST_BUCKET', 'tst-mk-gc')
